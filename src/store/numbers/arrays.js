...
export const cylinder = [27, 13, 36, 11, 30, 8, 23, 10, 5, 24, 16, 33];
export const orphelin = [1, 20, 14, 31, 9, 6, 34, 17];
export const voison = [22, 18, 29, 7, 28, 12, 35, 3, 26, 0, 32, 15, 19, 4, 21, 2, 25];
export const jeu0 = [12, 35, 3, 26, 0, 32, 15];
